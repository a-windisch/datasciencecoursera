...
cat("\n\n")
cat("Based on this [1] data set:\n")
cat("==================================================================\n")
cat("Human Activity Recognition Using Smartphones Dataset\n")
cat("Version 1.0\n")
cat("==================================================================\n")
cat("Jorge L. Reyes-Ortiz, Davide Anguita, Alessandro Ghio, Luca Oneto.\n")
cat("Smartlab - Non Linear Complex Systems Laboratory\n")
cat("DITEN - Università degli Studi di Genova.\n")
cat("Via Opera Pia 11A, I-16145, Genoa, Italy.\n")
cat("activityrecognition@smartlab.ws\n")
cat("www.smartlab.ws\n")
cat("==================================================================\n")
cat("\n\n")
cat("## 1. Data sets \n")
cat("There are two data sets, Xtotal and Xtotalaverage.\n")
cat("- Dimensions Xtotal       : ", dim(Xtotal),"\n")
